 ...
 */
public class FhirDifferentialSkeletonNode extends TreeNode<FhirDifferentialSkeletonData, FhirDifferentialSkeletonNode>{
	...
	private SnapshotTreeNode findMatchingSnapshotNodeReinstateChoiceSuffixIfNecessary(String differentialPath, SnapshotTreeNode searchRoot,
			String possibleSnapshotElementPath) {
		List<SnapshotTreeNode> possibleAncestorNodes = searchRoot.descendantsWithPath(possibleSnapshotElementPath);
